...
module fir
 #(
  ...
  (
    ...
    initial begin
        coeff[0] = 16'h04F0;  //  1264 in hexadecimal               
        coeff[1] = 16'h3B10;  // 15120 in hexadecimal             
        coeff[2] = 16'h3B10;  // 15120 in hexadecimal            
        coeff[3] = 16'h04F0;  //  1264 in hexadecimal             
    end

    //! Shift Register model
    always @(posedge clk) 
        begin: shift_register_accumulation
        if (rst) 
            begin
